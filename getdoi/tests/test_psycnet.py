...
class TestPsycNET(unittest.TestCase):
    ...
    def test_SSLStateInPsycNET(self):
        ...
        ssl_on = SSLStateInPsycNET('https://')
        self.assertEqual(ssl_on.get_doi_url(), 'https://dx.doi.org/')
        self.assertEqual(ssl_on.get_psycnet_url(), 'https://psycnet.apa.org/doi/')
        ssl_off = SSLStateInPsycNET('http://')
        self.assertEqual(ssl_off.get_doi_url(), 'http://dx.doi.org/')
        self.assertEqual(ssl_off.get_psycnet_url(), 'http://psycnet.apa.org/doi/')
